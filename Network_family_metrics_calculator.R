...
#directory = "/home/poulami/Dropbox/Poulami-project/to-share/results/network-file"
filenames <- list.files(path="/home/poulami/Dropbox/Poulami-project/to-share/network-files-sd",pattern="*.net")
setwd(file.path(paste("/home/poulami/Dropbox/Poulami-project/to-share/network-files-sd")))
